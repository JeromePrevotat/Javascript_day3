...
TaskManager.prototype.errorHandler = function(task) {
    if (task == null) return () => {
...
TaskManager.prototype.filterByKeyword = function(keyword) {
...
TaskManager.prototype.filterByDate = function(startDate, endDate) {
